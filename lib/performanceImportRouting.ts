...
// Il mapping PMS(BD)->structures.id (es. "Palazzo De' Belli" -> "Dimora De
// Belli") e la risoluzione bloccante struttura-da-filename per il
// guardrail dell'import Nazionalità/ADR-RevPAR sono stati spostati in
// lib/performance/ingestion/ (routing.ts, tabella DB
// structure_source_aliases - Import Integrity Foundation Fase 1): prima
// vivevano qui come BD_STRUCTURE_NAME_ALIASES, una costante hardcoded in
// codice. Il matching runtime ora legge gli alias dal DB, mai da una
// costante - vedi lib/performance/ingestion/routing.ts
// (resolveBookingDesignerStructure) e la migration
// 20260908113000_structure_source_aliases.sql.
