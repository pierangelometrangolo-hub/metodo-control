  ...
  return (
    <Link
      ...
      className={`group relative overflow-hidden rounded-[20px] border p-5 transition duration-200 ${
        active
          ? "border-teal bg-[linear-gradient(180deg,#f5fbfc_0%,#eef7f9_100%)] shadow-[0_12px_30px_rgba(1,122,146,0.10)]"
    ...
    >
      ...
      <p className="mt-4 text-[42px] font-semibold leading-none tracking-[-0.03em] text-near-black">
        {value}
      </p>
